    ...
    <div className="space-y-6">
      <section className="studio-panel rounded-lg p-6">
        <div className="max-w-3xl">
          <p className="mb-2 text-sm font-bold text-sky-700">MVP Placeholder</p>
      ...
      <div className="grid gap-6 lg:grid-cols-[380px_1fr]">
        <aside className="space-y-4">
          <section className="studio-panel rounded-lg p-5">
            ...
            <label className="mt-4 flex cursor-pointer items-center gap-3 rounded-md border border-dashed border-sky-300 bg-sky-50 p-4 text-sm font-bold text-sky-700">
            ...
            <div className="relative h-[640px] overflow-hidden rounded-[26px] bg-slate-950">
              <div className="absolute inset-0 grid place-items-center bg-gradient-to-br from-slate-900 via-slate-800 to-sky-950 text-white">
                <div className="text-center">
                  <Video className="mx-auto mb-4 size-14 text-sky-300" aria-hidden />
              ...
              <button className="absolute bottom-16 left-1/2 min-h-12 w-56 -translate-x-1/2 rounded-md bg-sky-500 text-sm font-black text-white shadow-glow">
                {cta}
              </button>
            </div>
          </div>
